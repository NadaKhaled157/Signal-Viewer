...
class PolarWindow(QMainWindow):
    def __init__(self, timestamps, signal_values, signal_label, signal_color):
        super().__init__()
        ...
        # Signal Drawing
        self.signal, = self.ax.plot([], [], color=self.signal_color)  # initialize signal
        self.ani = animation.FuncAnimation(self.fig, self.update_plot, frames=range(0, len(self.time), 5),
    ...
    def init_ui(self):
        ...
        window_icon = QIcon('Deliverables/polar_icon.png')
        ...
        self.signal_label.setFixedHeight(100)
