...
class MainWindow(QMainWindow):  # inherits from QMainWindow
    ...
    def initUI(self):
        ...
        channel_one_layout.addWidget(self.plot_widget)
    ...
    def update_plot(self):
        self.plot_widget_two.plot(self.data_fetcher.latitude_data, self.data_fetcher.longitude_data, pen=pg.mkPen(color='r', width=2), symbol='o',
                                  symbolBrush='b')
